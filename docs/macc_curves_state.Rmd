...
```{r}
macc_byTech_updated(current_data, sectorSelect = "LIVE", splitFig = TRUE)
macc_byTech_updated(current_data, sectorSelect = "LIVE", yearSelect = 2050, splitFig = TRUE)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "CROP", splitFig = TRUE)
macc_byTech_updated(current_data, sectorSelect = "CROP", yearSelect = 2050, splitFig = TRUE)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "RICE", splitFig = TRUE)
macc_byTech_updated(current_data, sectorSelect = "RICE", yearSelect = 2050, splitFig = TRUE)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "EPS")
macc_byTech_updated(current_data, sectorSelect = "EPS", yearSelect = 2050)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "NAA")
macc_byTech_updated(current_data, sectorSelect = "NAA", yearSelect = 2050)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "Metals")
macc_byTech_updated(current_data, sectorSelect = "Metals", yearSelect = 2050)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "ODS-Subs")
macc_byTech_updated(current_data, sectorSelect = "ODS-Subs", yearSelect = 2050)
...
```{r}
macc_byTech_updated(current_data, sectorSelect = "Electronics")
macc_byTech_updated(current_data, sectorSelect = "Electronics", yearSelect = 2050)
